        ...
        <div class="page" id="top">
            ...
            <section class="home-section bg-dark-alfa-30 fixed-height-small" data-background="images/mobile-video-placeholder.jpg" id="home">
                <div class="js-height-parent container">
                    ...
                    <!-- Video BG Init -->
                    <div class="player" data-property="{videoURL:'https://youtu.be/agrf8u167To',containment:'#home',autoPlay:true, showControls:false, showYTLogo: false, mute:true, startAt:0, opacity:1}">
                    </div>
                     <!-- End Video BG Init -->
