    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2 pr-0">
                <div class="logo" style="background-color:cornflowerblue;">
                    <a href="index.html">
                        <img src="{{asset("app_resources/assets/img/logo/C21_Blue_Logo.png")}}" width="116" height="116" alt="">
                    </a>
                </div>
            ...
            <div class="col-lg-10 header-nav-item">
                <div class="ts-breaking-news clearfix">
                    ...
                    <div class="breaking-news-content owl-carousel float-left" id="breaking_slider">
                        @foreach($breaking as $breaking)

                                <div class="breaking-post-content">

                                    <p>
                                        <a href="{{$breaking->link}}">{{$breaking->description}}</a>
                                    </p>
